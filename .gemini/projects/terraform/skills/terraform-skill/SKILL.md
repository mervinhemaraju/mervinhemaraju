...
**Don't use for:** basic HCL syntax questions Gemini already knows, provider API reference (link to docs), cloud-platform questions unrelated to Terraform/OpenTofu.
